    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <header className="mb-8">
        <h1 className="text-2xl font-bold text-zinc-100 font-mono flex items-center">
          <span className="bg-blue-500/20 text-blue-400 px-2 py-1 rounded mr-3 text-sm">CI/CD</span>
          Workflow Runs
        </h1>
        <p className="text-zinc-400 mt-2">Monitor CI/CD pipeline status across all repositories</p>
      </header>
