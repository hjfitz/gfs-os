		...
		switch (reason) {
			case "repository-not-found":
				return {
					...
					suggestion:
						"Check the repository name or your permissions and try again.",
				};
			case "workflow-not-found":
				return {
					...
					suggestion:
						"Check the workflow ID or navigate to the workflows page to see all available workflows.",
				};
			case "pull-request-not-found":
				return {
					...
					message:
						"The pull request you're looking for doesn't exist or has been closed.",
					suggestion:
	...
	return (
		<main className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-blue-950 flex flex-col items-center justify-center p-4">
			<div className="max-w-md w-full bg-zinc-900/40 border border-zinc-800 rounded-lg p-8 text-center">
				...
				<h1 className="text-2xl font-bold text-zinc-100 font-mono mb-2">
					{content.title}
				</h1>
