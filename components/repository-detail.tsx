...
const RepositoryDetail = ({
	...
	<Card className="bg-zinc-900/40 border-zinc-800 backdrop-blur-sm overflow-hidden">
		<div
			className={`h-1 w-full ${pipelineStatus ? "bg-emerald-500" : "bg-red-500"}`}
		/>
		<div className="p-6">
			<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
				<div>
					<h1 className="text-2xl font-bold text-zinc-100 font-mono flex items-center">
						...
						<Badge
							variant="outline"
							className="ml-3 font-mono text-xs bg-zinc-800/50 text-zinc-400"
						>
				...
				<div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
					<div className="bg-zinc-800/50 rounded-md p-3 flex flex-col">
						...
						<span
							className={`text-lg font-mono ${pipelineStatus ? "text-emerald-400" : "text-red-400"}`}
						>
